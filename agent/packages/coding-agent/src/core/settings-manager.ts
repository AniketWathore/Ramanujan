...
export interface Settings {
	...
	enableSkillCommands?: boolean; // Ramanujan fork default: false - skills hidden from `/` menu unless enabled in settings.json
...
export class SettingsManager {
	...
	getEnableSkillCommands(): boolean {
		// Ramanujan fork: skills are hidden from the `/` menu by default
		// (pi default is true). Re-enable in settings.json if ever needed.
		return this.settings.enableSkillCommands ?? false;
	}
